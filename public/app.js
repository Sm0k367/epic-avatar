// ===================================
// AI Avatar Web Application (Vercel Version)
// Serverless API instead of WebSocket
// ===================================
...
class AIAvatarApp {
    constructor() {
        ...
        this.isConnected = true; // Always connected in serverless
        ...
        try {
            ...
            reader.onloadend = async () => {
                ...
                if (transcribeData.success) {
                    ...
                    if (chatData.success) {
                        this.addMessage('assistant', chatData.message);
                    }
                } else {
            ...
            this.showError('Failed to process audio message');
            this.hideTypingIndicator();
        }
    }
